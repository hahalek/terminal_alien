...
class Shrimp():
    ...
    def print_at(self, x: int, y: int, wait: float = 0.3) -> None:
...
shrimp.print_at_reverse(0, 0,  2)
shrimp.print_at_reverse(5, 5, 10)
shrimp.print_at_reverse(10, 10, 10)
shrimp.print_at(15, 15)
shrimp.print_at(20, 14, 2)
shrimp.print_at(23, 18)
